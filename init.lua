...
vim.opt.synmaxcol = 10000000 -- syntax highlighting limit
...
vim.opt.guifont = { "JetBrains Nerd Font", ":h14" }
...
vim.pack.add({
	...
	"https://www.github.com/alexghergh/nvim-tmux-navigation",
...
require("diffview")
require("gounit").setup({
	gounit_bin = os.getenv("HOME") .. "/go/bin/gounit",
})
...
vim.keymap.set("n", "<leader>gtr", ":normal vaf<cr>:GoUnit<cr>", { desc = "GoUnit" })
