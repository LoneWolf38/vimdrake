...
keymap.Set("n", "<leader>[", "<cmd>lua require('harpoon.ui').nav_prev()<cr>", { desc = "Harpoon Nav prev" })
keymap.Set("n", "<leader>]", "<cmd>lua require('harpoon.ui').nav_next()<cr>", { desc = "Harpoon Nav next" })
