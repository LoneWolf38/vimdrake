return {
  ...
  ssh_config = {
    ...
    ssh_config_file_paths = { "/Users/debabratachoudhury/.lima/dev/ssh.config" }, -- Which files should be considered to contain the ssh host configurations. -- NOTE: `Include` is respected in the provided files.
